# deteccao_template.py
# Copie este arquivo para deteccao.py e preencha com suas credenciais reais
...
cred = credentials.Certificate("/caminho/para/seu/firebase_key.json")  # Substitua pelo caminho correto
...
model = YOLO('/caminho/para/seu/modelo/yolov8n_full_integer_quant_edgetpu.tflite', task='detect')

vs = VideoStream().start()
time.sleep(3)

with open("/caminho/para/seu/modelo/classes.txt", "r") as my_file:
