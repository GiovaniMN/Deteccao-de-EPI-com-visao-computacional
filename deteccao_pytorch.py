...
class CleanConfig:
    ...
    # MUDANÇA: Usar .pt ao invés de .tflite
    MODEL_PATH = '/home/epirasp/Desktop/coral_epi/modelos/yolov8n.pt'
...
#PREPROCESSAMENTO (mantido igual, mas não usado no .pt)
...
class CleanEPIController:
    def __init__(self):
        ...
        # MUDANÇA: Carregar modelo .pt ao invés de Edge TPU
    ...
    def detect_objects(self, frame):
        ...
        try:
            # MUDANÇA: Usar YOLOv8 .pt ao invés de Edge TPU
            ...
            # MUDANÇA: Processar resultados do YOLOv8 .pt
            if results and results[0].boxes is not None:
                for box in results[0].boxes:
                    # Extrair dados do YOLOv8
                    xyxy = box.xyxy[0].cpu().numpy()
                    conf = float(box.conf[0].cpu().numpy())
                    cls = int(box.cls[0].cpu().numpy())
                    
                    # Usar o mesmo processamento que o Edge TPU
    ...
    def _process_detection_balanced(self, data, scale, pad_top, pad_left, frame_shape):
        try:
            ...
            # Para .pt, as coordenadas já estão corretas
...
#FIREBASE E TELEGRAM (mantidos iguais)
